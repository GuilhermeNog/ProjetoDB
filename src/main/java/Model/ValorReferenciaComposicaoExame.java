...
public class ValorReferenciaComposicaoExame extends GenericModel {
    ...
    public ValorReferenciaComposicaoExame(Integer id, String valor_minimo, String valor_maximo, String limitador_minimo, String limitador_maximo, Integer unidade_medida_id) {
